...
constructor.add_object(data=df1, object_type='chart', position=chart_loc_1, object_format={"chart_type": "bar"})
constructor.add_object(data=df2, object_type='chart', position=chart_loc_1, object_format={"chart_type": "line"})
constructor.add_object(data=df3, object_type='chart', position=chart_loc_1, object_format={"chart_type": "stackcolumn"})
